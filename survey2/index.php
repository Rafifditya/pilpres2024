<?php 
        ...
        function getParnasZon(){
            $xml=simplexml_load_file("partai_nasional_perzonasi.xml") or die("Error: Cannot create object");
            $array = [];
            foreach($xml->data->item as $row){
                $array[] = array(
                    'namazonasi' => $row->namazonasi .'',
                    'partai1' => $row->partai1 .'',
                    'partai2' => $row->partai2 .'',
                    'partai3' => $row->partai3 .'',
                    'partai4' => $row->partai4 .'',
        ...
        function getPilnasZon(){
            $xml=simplexml_load_file("pilpres_nasional_perzonasi.xml") or die("Error: Cannot create object");
            $array = [];
            foreach($xml->data->item as $row){
                $array[] = array(
                    'namazonasi' => $row->namazonasi .'',
        ...
        $result = array(
         ...
         'pilpres_nasional_perzonasi' => getPilnasZon(),
         'partai_nasional_perzonasi' => getParnasZon()
        );
