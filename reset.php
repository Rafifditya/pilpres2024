<?php 
   ...
   function getPilpresnas(){
    ...
    $item->addChild("datamasuk",rand_float(0,0))->addAttribute('type','float');
    $item->addChild("tingkatpartisipasi",rand_float(0,0))->addAttribute('type','float');
