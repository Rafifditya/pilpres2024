<?php 
    $xml=simplexml_load_file("https://api-qc.chartapolitika.com/v1/parsing-data/MSE003/zona?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..UTv_x5ksa7aaxLPxPL6FlJrfU6XflI4YcgHhdtJxwrU&type=xml") or die("Error: Cannot create object");
    for($i=0;$i<10;$i++){
        $data [] = array(
